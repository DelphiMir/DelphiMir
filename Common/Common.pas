...
//-----------------------------------------------
  ...
  DB_LOADRANKING = 1007; //读取排行榜        //珐欧 眠啊
  DBR_LOADRANKING = 1107; //读取排行榜        //珐欧 眠啊
...
type
  TProgamType = (tDBServer, tLoginSrv, tLogServer, tM2Server, tLoginGate,
    ...
    tRunGate3, tRunGate4, tRunGate5, tRunGate6, tRunGate7, tRanking);
