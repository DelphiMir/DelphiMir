...
interface
uses
  svn, Windows,Messages,Classes,SysUtils,JSocket,IniFiles,Grobal2,MudUtil;
type
  TGateInfo = record
...
//  sDBHeaderDesc      :String = 'legend of mir database file 1999/1';
  ...
  nLevel2            :Integer = 28;        //清理等级 2
  nLevel3            :Integer = 50;       //清理等级 3

  nDay1              :Integer = 7;       //清理未登录天数 1
  nDay2              :Integer = 30;      //清理未登录天数 2
  nDay3              :Integer = 60;      //清理未登录天数 3
...
begin
  ...
  if Conf <> nil then begin
    ...
    nMakeBonze:=Conf.ReadInteger('Setup','MakeBonze',nMakeBonze);
...
begin
  ...
  SVNRevision('$Id: DBShare.pas 595 2007-03-09 19:31:34Z damian $');
