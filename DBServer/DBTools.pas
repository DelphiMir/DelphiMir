...
uses HumDB, DBShare, Grobal2, SDK;
var
        ...
        try
          if NewChrDB.Open then begin
            if NewChrDB.ChrCountOfAccount(SrcHumanRCD.Data.sChrName) < 2 then begin
              ...
              HumRecord.btCount:=0;
              HumRecord.Header.sChrName:=SrcHumanRCD.Data.sChrName;
...
initialization
  SVNRevision('$Id: DBTools.pas 531 2006-12-19 13:13:36Z damian $');
end.
