...
begin
  ...
  EditPayPoint.Value  :=m_ChrRcd.Data.nPCPoint;
...
begin
  ...
  try
    if HumDataDB.Open then begin
      nIdx:=HumDataDB.Index(m_ChrRcd.Header.sChrName);
...
begin
  ...
  if Sender = EditPayPoint then begin
    m_ChrRcd.Data.nPCPoint:=EditPayPoint.Value;
  end else
...
initialization
  SVNRevision('$Id: EditRcd.pas 595 2007-03-09 19:31:34Z damian $');
end.
