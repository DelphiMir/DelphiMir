...
begin
  ERowCount.Value:=8;
  AddrGrid.Cells[0,0]:='·þÎñÆ÷µØÖ·';
  AddrGrid.Cells[1,0]:='Íø¹ØµØÖ·';
  AddrGrid.Cells[2,0]:='¶Ë¿Ú';
  AddrGrid.Cells[3,0]:='Íø¹ØµØÖ·';
  AddrGrid.Cells[4,0]:='¶Ë¿Ú';
  AddrGrid.Cells[5,0]:='Íø¹ØµØÖ·';
  AddrGrid.Cells[6,0]:='¶Ë¿Ú';
  AddrGrid.Cells[7,0]:='Íø¹ØµØÖ·';
  AddrGrid.Cells[8,0]:='¶Ë¿Ú';
end;
...
begin
  ...
  try
    ...
    ShowMessage(sGateConfFileName + '±£´æÊ§°Ü£¡');
  end;
  Self.Close;
end;
