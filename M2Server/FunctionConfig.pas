...
type
  TfrmFunctionConfig = class(TForm)
    ...
    Label114: TLabel;
    Label115: TLabel;
    Mag53Spin1: TSpinEdit;
    Mag53Spin2: TSpinEdit;
    Label116: TLabel;
    Label117: TLabel;
    Label118: TLabel;
    EditCatleGuildNameColor: TSpinEdit;
    LabelCatleGuildNameColor: TLabel;
    TabSheet5: TTabSheet;
    ButtonMagDelaySave: TButton;
    GroupBox50: TGroupBox;
    Label121: TLabel;
    EditMagMassPoisonDelay: TSpinEdit;
    ButtonMagDelayCancel: TButton;
    GroupBox51: TGroupBox;
    GroupBox52: TGroupBox;
    Label124: TLabel;
    EditElecBlizzardLevel: TSpinEdit;
    Label112: TLabel;
    EditCatleWarGuildNameColor: TSpinEdit;
    LabelCatleWarGuildNameColor: TLabel;
    Label119: TLabel;
    Label122: TLabel;
    EditNamCatleGuildNameColor: TSpinEdit;
    EditKingCatleGuildNameColor: TSpinEdit;
    LabelKingCatleGuildNameColor: TLabel;
    LabelNamCatleGuildNameColor: TLabel;
    GroupBox7: TGroupBox;
    CheckNeutralityAttack: TCheckBox;
    GroupBox47: TGroupBox;
    Label137: TLabel;
    SpinBonusPointEdit: TSpinEdit;
    ...
    procedure EditCatleGuildNameColorChange(Sender: TObject);
    procedure ButtonMagDelaySaveClick(Sender: TObject);
    procedure ButtonMagDelayCancelClick(Sender: TObject);
    procedure EditMagMassPoisonDelayChange(Sender: TObject);
    procedure EditElecBlizzardLevelChange(Sender: TObject);
    procedure EditCatleWarGuildNameColorChange(Sender: TObject);
    procedure EditNamCatleGuildNameColorChange(Sender: TObject);
    procedure EditKingCatleGuildNameColorChange(Sender: TObject);
    procedure CheckNeutralityAttackClick(Sender: TObject);
    procedure SpinBonusPointEditChange(Sender: TObject);
...
begin
  ...
  SpinBonusPointEdit.Value:=g_Config.nBonusPointHack;
...
begin
  ...
  EditCatleGuildNameColor.Value:=g_Config.btCatleGuildNameColor;
  EditNamCatleGuildNameColor.Value:=g_Config.btNamCatleGuildNameColor;
  EditKingCatleGuildNameColor.Value:=g_Config.btKingCatleGuildNameColor;
  EditCatleWarGuildNameColor.Value:=g_Config.btCatleWarGuildNameColor;

  LabelPKFlagNameColor.Color:=GetRGB(EditPKFlagNameColor.Value);
  LabelPKLevel1NameColor.Color:=GetRGB(EditPKLevel1NameColor.Value);
  LabelPKLevel2NameColor.Color:=GetRGB(EditPKLevel2NameColor.Value);
  LabelWarGuildNameColor.Color:=GetRGB(EditWarGuildNameColor.Value);
  LabelAllyAndGuildNameColor.Color:=GetRGB(EditAllyAndGuildNameColor.Value);
  LabelInFreePKAreaNameColor.Color:=GetRGB(EditInFreePKAreaNameColor.Value);
  LabelCatleGuildNameColor.Color:=GetRGB(EditCatleGuildNameColor.Value);
  LabelNamCatleGuildNameColor.Color:=GetRGB(EditNamCatleGuildNameColor.Value);
  LabelKingCatleGuildNameColor.Color:=GetRGB(EditKingCatleGuildNameColor.Value);
  LabelCatleWarGuildNameColor.Color:=GetRGB(EditCatleWarGuildNameColor.Value);
end;
...
begin
  ...
  EditElecBlizzardLevel.Value:=g_Config.nLightFlowerStruckLevel;
...
procedure TfrmFunctionConfig.EditElecBlizzardLevelChange(Sender: TObject);
begin
  if not boOpened then exit;
  g_Config.nLightFlowerStruckLevel :=EditElecBlizzardLevel.Value;
  ModValue();
end;
...
procedure TfrmFunctionConfig.RefMagDelay();
begin

  EditMagMassPoisonDelay.Value:=g_Config.nMagMassPoisonDelay;
...
begin
  ...
  CheckNeutralityAttack.Checked:=g_Config.boNeutralityAttack;
end;
...
procedure TfrmFunctionConfig.EditCatleGuildNameColorChange(
  Sender: TObject);
var
  btColor:Byte;
begin
  btColor:=EditCatleGuildNameColor.Value;
  LabelCatleGuildNameColor.Color:=GetRGB(btColor);
  if not boOpened then exit;
  g_Config.btCatleGuildNameColor:=btColor;
  ModValue();
end;

procedure TfrmFunctionConfig.EditMagMassPoisonDelayChange(Sender: TObject);
begin
  if not boOpened then exit;
  g_Config.nMagMassPoisonDelay:=EditMagMassPoisonDelay.Value;
  ModValue();
end;

procedure TfrmFunctionConfig.ButtonMagDelaySaveClick(Sender: TObject);
begin
...
procedure TfrmFunctionConfig.ButtonMagDelayCancelClick(Sender: TObject);
begin
  if Application.MessageBox('您确定要将此页面重置为默认值吗？', '确认信息', MB_YESNO + MB_ICONQUESTION) <> IDYES then begin
    exit;
  end;

  g_Config.nMagMassPoisonDelay:=4;
...
procedure TfrmFunctionConfig.EditCatleWarGuildNameColorChange(
  Sender: TObject);
var
  btColor:Byte;
begin
  btColor:=EditCatleWarGuildNameColor.Value;
  LabelCatleWarGuildNameColor.Color:=GetRGB(btColor);
  if not boOpened then exit;
  g_Config.btCatleWarGuildNameColor:=btColor;
  ModValue()
end;

procedure TfrmFunctionConfig.EditNamCatleGuildNameColorChange(
  Sender: TObject);
var
  btColor:Byte;
begin
  btColor:=EditNamCatleGuildNameColor.Value;
  LabelNamCatleGuildNameColor.Color:=GetRGB(btColor);
  if not boOpened then exit;
  g_Config.btNamCatleGuildNameColor:=btColor;
  ModValue();
end;

procedure TfrmFunctionConfig.EditKingCatleGuildNameColorChange(
  Sender: TObject);
var
  btColor:Byte;
begin
  btColor:=EditKingCatleGuildNameColor.Value;
  LabelKingCatleGuildNameColor.Color:=GetRGB(btColor);
  if not boOpened then exit;
  g_Config.btKingCatleGuildNameColor:=btColor;
  ModValue();
end;

procedure TfrmFunctionConfig.CheckNeutralityAttackClick(Sender: TObject);
begin
  if not boOpened then exit;
  g_Config.boNeutralityAttack:=CheckNeutralityAttack.Checked;
  ModValue();
end;

procedure TfrmFunctionConfig.SpinBonusPointEditChange(Sender: TObject);
begin
  if not boOpened then exit;
  g_Config.nBonusPointHack:=SpinBonusPointEdit.Value;
  ModValue();
end;
