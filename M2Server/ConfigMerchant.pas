...
begin
  ...
  if SelMerchant.m_boMakeGem then LineText:=LineText + sMAKEGEM + ' ';
  ...
  if SelMerchant.m_boSendmsg2 then LineText:=LineText + sSL_SENDMSG2 + ' ';
  LineText:=LineText + ')';
...
initialization
  //SVNRevision('$Id: ConfigMerchant.pas 327 2006-08-24 20:30:52Z Dataforce $');
end.
