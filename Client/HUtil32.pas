...
function  FloatToStrFixFmt2 (fVal: Double; prec, digit: Integer): string;  //³¬½Ã
...
function  IntToBool(boo: Integer): Boolean;
...
procedure SafeFillChar(out X; Count: Integer; V: Boolean); overload;
...
procedure SafeFillChar(out X; Count: Integer; V: Boolean);
begin
  FillChar(X, Count, V);
end;
...
initialization
  //SVNRevision('$Id: HUtil32.pas 523 2006-12-16 10:08:26Z damian $');
end.
