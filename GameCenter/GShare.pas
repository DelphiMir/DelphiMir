...
resourcestring
  m_sGameName = 'The Ares';
  m_sCapTion = 'Mir2: The Ares';
  m_sVersion = 'Mir2: The Ares GameCenter';
const
  MAXRUNGATECOUNT = 8;
type
  TProgram = record
...
var
  ...
  g_nFormIdx: Integer;
  g_IniConf: Tinifile;
  g_sButtonStartGame: string = '서버시작';
  g_sButtonStopGame: string = '서버종료';
  g_sButtonStopStartGame: string = '서버 시작중';
  g_sButtonStopStopGame: string = '서버 중지';

  g_sGameDirectory: string = '.\';

  g_sDBServerDirectory: string = '.\';
  g_sLoginServerDirectory: string = '.\';
  g_sLogServerDirectory: string = '.\';

  g_sConfFile: string = '.\GameCenter.ini';
  ...
  g_nLimitOnlineUser: Integer = 2000; //The maximum number of online users
  ...
  g_sDBServer_Config_MapFile: string = 'M2Server\Envir\맵정보설정.txt';
  ...
  g_sLoginServer_GateAddr: string = '0.0.0.0';
  g_nLoginServer_GatePort: Integer = 5500;
  g_sLoginServer_ServerAddr: string = '0.0.0.0';
  ...
  g_sRanking_ProgramFile: string = 'PlugTop.exe';
  g_sRanking_Directory: string = 'M2Server\';
  g_boRanking_GetStart: Boolean = True;
  g_nRanking_MainFormX: Integer = 251;
  g_nRanking_MainFormY: Integer = 239;


  g_sM2Server_ProgramFile: string = 'M2Server.exe';
  g_sM2Server_Directory: string = 'M2Server\';
  g_sM2ServerDirectory: string = '.\';
  ...
  g_RunGateInfo: array[0..MAXRUNGATECOUNT - 1] of TRunGateInfo; //2011-08-01 Increase

  DBServer: TProgram;
  LoginServer: TProgram;
  LogServer: TProgram;
  M2Server: TProgram;
  RunGate: array[0..MAXRUNGATECOUNT - 1] of TProgram; //2011-08-01 Increase
  {RunGate1       :TProgram;
  RunGate2       :TProgram;
  RunGate3       :TProgram;
  RunGate4       :TProgram;
  ...
  g_BackUpManager: TBackUpManager; //File backup
