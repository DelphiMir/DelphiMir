...
const
  ...
  SG_USERACCOUNT = 1003;
  SG_USERACCOUNTNOTFOUND = 1004; //Account not found
  SG_USERACCOUNTCHANGESTATUS = 1005; //Account updated successfully
  SG_CHECKCODEADDR = 1006;


  SG_FORMHANDLE = 1000; //Account server HANLD
  SG_STARTNOW = 1001; //Starting login server...
  SG_STARTOK = 1002; //Login server has started...
...
resourcestring
  sDBHeaderDesc = 'Game Database file 2011/08/01';
  sDBIdxHeaderDesc = 'Game Database index file 2011/08/01';
type
