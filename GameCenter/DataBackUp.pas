//
//           2006-11-12 Multi-task data backup unit
//           QQ: 240621028
//
            ...
            0: if IsBackUp then begin
                ...
                if m_boZip then begin
                  if m_nErrorCount < 2 then begin
                    ...
                    if not DirectoryExists(sDest) then ForceDirectories(sDest); //Create a directory
                  ...
                  for I := 0 to m_BackUpFileList.Count - 1 do begin
                    ...
                    sLineText := AnsiReplaceText(sLineText, m_sSourceDir, sDest); //New file path
                    sNewDir := GetDirName(sLineText);
                    if not DirectoryExists(sNewDir) then ForceDirectories(sNewDir); //Create a directory
...
begin
  with ShFileOpStruct do begin
    wFunc := FO_COPY; {Copy FO_COPY Delete FO_DELETE Move FO_MOVE Rename FO_RENAME}
